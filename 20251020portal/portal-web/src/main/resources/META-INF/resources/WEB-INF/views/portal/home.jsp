        ...
        <div class="modules-container">
            ...
            <div class="module-wrapper">
                ...
                <div class="module-content">
                    ...
                    <iframe src="http://localhost:8084/module4/" class="module-frame" id="module3Frame" onload="hideLoading('loading4')" scrolling="no"></iframe>
                </div>
                <div class="module-footer">
                    <a href="http://localhost:8084/module4/" target="_blank" class="module-link">모듈 4 전체보기</a>
                </div>
            </div>
        </div>
    </div>
